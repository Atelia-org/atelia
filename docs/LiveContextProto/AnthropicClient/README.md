...
> [`docs/Completion/quick-start.md`](https://github.com/Atelia-org/atelia-completion/blob/v0.1.0-preview.1/docs/Completion/quick-start.md)；current adapter有意不暴露caller-selected
