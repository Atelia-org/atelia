...
| 审阅 approved public API / wire-format surface与remaining candidate | [Contract R2 approved surfaces and candidate map](current/contracts/session-journal-contract-r2.md) | immutable v1/v2/v3/v4/v5 tags分别锚定surface sets 1/2/3/4/5；[surface set 5 addendum](evidence/contract-freeze-r2-approval-surface-set-5.md)记录Cadence receipt exact窄scope与non-promises；[plan](work/active/session-journal-contract-freeze-r2.md)保留其余Defer边界 |
