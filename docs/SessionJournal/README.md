...
| 审阅 Galatea root `config.json` | [Root config V10 current contract](current/contracts/galatea-root-config-v10.md)、[Galatea guide](../../prototypes/Galatea/README.md) | characters/players/runtime 分离、零 Player、每角色 heartbeatEnabled；旧 V1–V9 合同与 approval 只保留历史语义，不能作为当前启动规则 |
