...
| Grid Store、Control、Manager、Getter 与 Runtime | [Grid concepts](current/derived-recap/concepts.md)、[target design](work/active/derived-recap-grid-target-design.md) | [Store SQLite v3](current/contracts/recap-grid-store-sqlite-v3.md)与owning product/tests；v3 实施验证见 [Store 计划](../Galatea/recap-store-simplification-plan.md)，旧 v2 的 surface-set-2 tag 只认证其历史格式 |
