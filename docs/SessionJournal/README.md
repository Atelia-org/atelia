...
- 当前 active plans：
  ...
  v3 tag锚定；additive surface set 4只新增HistoryLoad V2 exact top-level/read-only contract，已获用户授权但unified
  gates、independent review与v4 tag仍Pending；未列出的surface继续按Defer边界推进。
