...
| 生成或消费 HistoryLoad calibration report | [HistoryLoad report V2 candidate](current/contracts/history-load-report-v2.md)、[activation runbook](operations/galatea-g2a-staging-acceptance.md#2-import-and-raw-baseline) | exact 11-field producer-only gate；full planning window、unbounded/offline、无final byte cap/oversize contract；post-v3-tag candidate、approval Defer |
