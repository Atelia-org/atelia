...
状态：Archived historical plan；对应complete-roster owners已在WP-08 formal RecapGrid cutover candidate中退役  
...
本文性质：historical Shape / Rule / Plan evidence，不描述current implementation/API
...
3. [`current RecapGrid concepts`](../../current/derived-recap/concepts.md)，用于核对formal cutover事实；
4. [`current architecture map`](../../current/architecture-and-code-map.md) 与对应formal product README；
5. 本文对应工作包列出的historical owning code/tests仅用于追溯。旧Planner/Maintainers owners已在
   WP-08 cutover退役。
