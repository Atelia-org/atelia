...
| 区分 Core Resume、historical Planner Resume 与 Restore | [Core guide §Send 与 recovery](../../../../prototypes/SessionJournal/README.md#send-与-recovery)；historical Planner guide（owner已退役） | Core recovery tests或frozen-execution historical evidence | 三者证明义务不同；本行只保留历史路由，不描述formal RecapGrid |
| 理解 EADR 术语、authority、cadence 与 ownership | [EADR concepts](../../current/derived-recap/concepts.md) | historical Store/Planner guides（owners已退役） | 本表已superseded；current ownership读architecture map |
| 修改 historical Store selection、publication、materialization 或 Restore | historical Store guide（owner已退役） | [EADR concepts](../../current/derived-recap/concepts.md) | 只用于历史追溯 |
| 修改 historical Planner cadence、NewPlanning、Resume 或 Restore | historical Planner guide（owner已退役） | [EADR concepts](../../current/derived-recap/concepts.md) | 只用于历史追溯 |
| 修改 historical config V2、repo loader、active roster 或 planning limits | [Config redirect](../../current/derived-recap/planner-config.md) | historical Planner guide（owner已退役） | 只用于历史追溯 |
| 修改 HistoryLoad estimator、framing、projection 或 threshold | [HistoryLoad current contract](../../current/derived-recap/history-load.md) | HistoryTimeline code/tests | 本表原Planner路由已退役 |
| 修改 historical Planner frozen Building、Resume/Restore 或 Host preparation order | historical Planner guide（owner已退役） | [Host Integration current contract](../../current/host-integration/derived-recap-host-integration.md) | 只用于历史追溯 |
...
| `eadr.store.current-usage` | historical v4 Store usage（owner已退役） | `component-guide` · `superseded` | frozen evidence `cf3c77d524abdf24352400c221e0c42f0c9cb2fe`；[DG1](../../evidence/document-governance-dg1-pilot.md) | 仅审计历史交付 |
| `eadr.planner.current-usage` | historical Planner usage（owner已退役） | `component-guide` · `superseded` | frozen evidence `cf3c77d524abdf24352400c221e0c42f0c9cb2fe`；[DG1](../../evidence/document-governance-dg1-pilot.md) | 仅审计历史交付 |
...
| `eadr.planner.frozen-execution-current` | historical frozen Planner execution（owner已退役） | `component-guide`, `canonical-contract` · `superseded` | frozen evidence `eda5ee979b5df1ab383fddf20d0691bb891a00d1` | 仅审计历史交付 |
