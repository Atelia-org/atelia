...
状态：WP-08 formal source cutover Complete；Store v3 切片已完成；当前 [Timeline 单一行身份](../../../Galatea/timeline-row-identity-simplification-plan.md)实施中，验证待补。raw selected `RefId` Parent lineage仍是唯一历史事实源。
