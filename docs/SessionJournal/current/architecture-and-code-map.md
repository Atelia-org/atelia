...
| profile/fingerprint catalog | [`RecapMaintainerProfileCatalog.cs`](../../../prototypes/SessionJournal.DerivedRecap.Maintainers/RecapMaintainerProfileCatalog.cs) | [`MaintainerIdentityTests.cs`](../../../tests/SessionJournal.DerivedRecap.Maintainers.Tests/MaintainerIdentityTests.cs) |
| concrete rewrite | [`RewriteRecapBlockMaintainer.cs`](../../../prototypes/SessionJournal.DerivedRecap.Maintainers/RewriteRecapBlockMaintainer.cs) | [`WorldUnderstandingRewriteRecapMaintainerTests.cs`](../../../tests/SessionJournal.DerivedRecap.Maintainers.Tests/WorldUnderstandingRewriteRecapMaintainerTests.cs) |
