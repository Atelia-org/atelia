...
[V4](galatea-root-config-v4.md)，在V3 required delegation storage基础上新增required per-user
`characterName`与startup prompt template materialization。下文由surface set 2 tag锚定的root V1内容及后来的
V2/V3合同仅保留prior history；旧tag不认证V2/V3/V4 delta，历史appendix与approval evidence不改写。
...
| Galatea root config | **Current product V5**：[current contract](galatea-root-config-v5.md) hard-cut exact `v:5`，保留required names并把operator完整prompt改为`characterContextTemplate*`，由binary code-owned prefix/suffix物化finalized prompt；V4 full-template、V3 delegation storage、V2 `sessionProvisioning`及**prior Approved Stable V1**分别见[历史V4](galatea-root-config-v4.md)/[历史V3](galatea-root-config-v3.md)/[历史V2](galatea-root-config-v2.md)/[V1 appendix](galatea-root-config-v1.md) | V2/V3/V4/V5不由旧tag认证；V1 product source `8c450bf0` + integration evidence `6c5d3d50`及immutable surface-set-2 approval均只保留历史含义 |
...
[root config V3](galatea-root-config-v3.md)与[root config V4](galatea-root-config-v4.md)，current又hard-cut到
[root config V5](galatea-root-config-v5.md)；
