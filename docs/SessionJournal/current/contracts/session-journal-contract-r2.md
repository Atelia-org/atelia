...
[V5](galatea-root-config-v5.md)：保留V4 required per-user names与delegation storage，operator改为只提供
...
不认证V2/V3/V4/V5 delta，历史appendix与approval evidence不改写。
