...
> 后继边界：本文保留 ResultIdentity 删除与 Control writer v3 的历史实现；后继 [Timeline 切片](timeline-row-identity-simplification-plan.md)已实现 writer v4、旧 2/3 codec 投影和单一 bootstrap RowId。
