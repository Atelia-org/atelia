...
| 简化 Galatea / RecapGrid 身份与恢复校验 | [设计与实施记录](identity-simplification-design.md)：adapter 门槛已删除并完成 E2E；下一切片是 [Control 回执简化](control-receipt-simplification-plan.md)（规划完成，尚未实施） |
