...
public static class TextAdv2RuntimeScaffold {
    public static TextAdv2RuntimeScaffoldInfo DescribeCurrentState() => new(
        ...
        Notes: [
            ...
            "world dump/location dump、compact movement text 与 route trace text 已从 runtime 主对象移出，改由显式 dev-support renderer 供宿主按需调用。",
            ...
            "TextAdv2Runtime public surface 已不再暴露调试文本输出或 TextAdv2RuntimeCommandResult；world/location dump 走显式 dev-support helper。"
        ]
    );
}
