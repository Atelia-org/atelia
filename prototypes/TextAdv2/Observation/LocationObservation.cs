...
/// </summary>
public sealed record ActorPresenceObservation(string ActorId, string ActorName);

/// <summary>
/// 基于 actor 的位置观察结果。
/// 这是“actor 站在何处，因此现在看到什么”的直接结构化投影。
/// </summary>
public sealed record ActorLocationObservation(string ActorId, string ActorName, LocationObservation Location);
