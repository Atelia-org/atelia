...
该appendix形成于immutable surface-set-4 tag之后；surface set 5 exact narrow scope已获用户批准且unified gates通过/
tag-ready，promotion draft review已PASS；final ledger re-review与authorized v5 tag仍Pending。
