...
namespace MemoTree.Core.Storage.Views {
    ...
    public record MemoryUsageStats {
        ...
        /// 视图状态占用内存字节数
        /// </summary>
        public long ViewStateMemoryBytes {
            get; init;
        }
    ...
    public record ViewStateStats {
        ...
        /// 最近访问的视图状态数量
        /// </summary>
        public int RecentlyAccessedStates {
            get; init;
        }
        ...
        /// 视图状态访问频率分布
        /// </summary>
        public IReadOnlyDictionary<string, int> AccessFrequencyDistribution {
            get; init;
        } =
    ...
    public record MemoryHealthStatus {
        ...
        public long WarningThresholdBytes {
            get; init;
        }
        public long CriticalThresholdBytes {
            get; init;
        }
