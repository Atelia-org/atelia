...
namespace MemoTree.Core.Storage.Relations {
    ...
    public class RelationValidationResult {
        ...
        /// 验证的关系数量
        /// </summary>
        public int ValidatedRelationCount {
            get; init;
        }
        ...
        /// 验证详情
        /// </summary>
        public IReadOnlyList<RelationValidationDetail> Details {
            get; init;
        } =
    ...
    public record PatternAnalysisStatistics {
        ...
        public IReadOnlyDictionary<string, int> PatternFrequency {
            get; init;
        } =
