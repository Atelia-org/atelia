...
public sealed class OpenAIChatToolSchemaProjectionTests {
    [Fact]
    public void ConvertToApiRequest_ProjectsRecursiveToolSchemaIntoFunctionParameters() {
        ...
        Assert.Equal("search_docs", tool.Function.Name);
