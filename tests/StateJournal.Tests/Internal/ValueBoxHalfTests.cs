...
/// <summary>
/// <see cref="ValueBox.HalfFace.From"/> 和 <see cref="ValueBox.HalfFace.Get"/> 的单元测试。
/// </summary>
/// <remarks>
/// 测试策略：
...
public class ValueBoxHalfTests {
    ...
    private static void AssertHalfRoundtrip(Half expected) {
        var box = ValueBox.HalfFace.From(expected);
        GetIssue issue = ValueBox.HalfFace.Get(box, out Half actual);
    ...
    public void FromHalf_NoPoolAllocation() {
        ...
        _ = ValueBox.HalfFace.From(Half.MaxValue);
        _ = ValueBox.HalfFace.From(Half.MinValue);
        _ = ValueBox.HalfFace.From(Half.NaN);
        _ = ValueBox.HalfFace.From(Half.PositiveInfinity);
    ...
    public void SameInlineSameValueBox_Half_EqualsDouble() =>
        Assert.Equal(ValueBox.HalfFace.From((Half)0.5).GetBits(), ValueBox.RoundedDoubleFace.From(0.5).GetBits());

    [Fact]
    public void SameInlineSameValueBox_Half_EqualsFloat() =>
        Assert.Equal(ValueBox.HalfFace.From((Half)1.0).GetBits(), ValueBox.SingleFace.From(1.0f).GetBits());
    ...
    public void GetHalf_FromDouble_OverflowedToInfinity() {
        ...
        var box = ValueBox.RoundedDoubleFace.From(100000.0);
        GetIssue issue = ValueBox.HalfFace.Get(box, out Half value);
    ...
    public void GetHalf_FromSmallInt_Exact() {
        var box = ValueBox.Int32Face.From(42);
        GetIssue issue = ValueBox.HalfFace.Get(box, out Half value);
        Assert.Equal(GetIssue.None, issue);
    ...
    public void GetHalf_FromInlineInt_11BitBoundary_Exact() {
        ...
        var box = ValueBox.Int32Face.From(2047);
        GetIssue issue = ValueBox.HalfFace.Get(box, out Half value);
        Assert.Equal(GetIssue.None, issue);
    ...
    public void GetHalf_FromInlineInt_PowerOf2_Exact() {
        ...
        var box = ValueBox.Int32Face.From(1024);
        GetIssue issue = ValueBox.HalfFace.Get(box, out Half value);
        Assert.Equal(GetIssue.None, issue);
    ...
    public void GetHalf_FromInlineInt_12Bit_PrecisionLost() {
        ...
        var box = ValueBox.Int32Face.From(2049);
        GetIssue issue = ValueBox.HalfFace.Get(box, out Half value);
        Assert.Equal(GetIssue.PrecisionLost, issue);
    ...
    public void GetHalf_FromInlineInt_BeyondHalfMax_OverflowedToInfinity() {
        ...
        var box = ValueBox.Int32Face.From(100000);
        GetIssue issue = ValueBox.HalfFace.Get(box, out Half value);
        Assert.Equal(GetIssue.OverflowedToInfinity, issue);
        Assert.Equal(Half.PositiveInfinity, value);
    }
